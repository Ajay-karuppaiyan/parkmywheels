          ...
          <div className="row align-items-center">
             <div className="col-lg-4 col-md-6">
                <div className="why-choose-item wow fadeInUp mb-4">
                  <div className="icon-box"><img src="/images/icon-why-choose-1.svg" alt="" /></div>
                ...
                <div className="why-choose-item wow fadeInUp" data-wow-delay="0.25s">
                  <div className="icon-box"><img src="/images/icon-why-choose-2.svg" alt="" /></div>
             ...
             <div className="col-lg-4 d-none d-lg-block text-center"><figure className="reveal"><img src="/images/why-choose-img.jpg" alt="" className="img-fluid rounded shadow" /></figure></div>
             <div className="col-lg-4 col-md-6">
                <div className="why-choose-item wow fadeInUp">
                  <div className="icon-box"><img src="/images/icon-why-choose-3.svg" alt="" /></div>
                ...
                <div className="why-choose-item wow fadeInUp mt-4" data-wow-delay="0.25s">
                  <div className="icon-box"><img src="/images/icon-why-choose-4.svg" alt="" /></div>
